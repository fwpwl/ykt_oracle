...
def get_db_client():
    ...
    数据库连接
    """
    db_client = OracleTransferHandler(connect_str="xhcom_ykt/xhcom_ykt_342z#@218.192.144.49:1522/ORCL")
    return db_client
...
def xhcom_get_course_data(year, term):
...
def xhcom_get_choose_data(year, term):

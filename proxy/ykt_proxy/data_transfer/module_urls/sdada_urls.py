...
from data_transfer.module_views.sdada_views import sdada_get_course_data_view, sdada_get_choose_data_view, \
    sdada_get_student_data_view, sdada_get_teacher_data_view, sdada_get_tra_data_view, sdada_get_department_data_view, sdada_get_gra_student_data_view
...
urlpatterns = [
    ...
    url(r'^get_gra_student_data/?$', sdada_get_gra_student_data_view),
]
